...
@section('content')
    <div class="card mb-4">
        ...
        <form class="card-body" action="{{ route('posts.store') }}" method="post" id="transactionForm">
            @csrf
            ...
            <div class="row g-3">
                ...
                <div class="col-md-12 mb-3">
                    <label class="block">
                        ...
                        <textarea class="form-control" id="description" name="description" placeholder="Masukan Content Postingan" rows="5">{{ old('description') }}</textarea>
                    </label>
                    @error('description')
                        <div class="invalid-feedback">
